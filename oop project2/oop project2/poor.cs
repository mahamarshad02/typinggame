...
{
    public partial class poor : Form
    {
        public poor()
        {
            InitializeComponent();
        ...
        private void poor_Load(object sender, EventArgs e)
        {
            ...
            p.ImageLocation = @"C:\Users\VC\Desktop\face (1).png";
            ...
            Label l = new Label();
            l.Text = "OOPS ! Your typing speed is poor.";
